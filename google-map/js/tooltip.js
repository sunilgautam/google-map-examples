...
function Tooltip(options) {
    ...
    this.showOnHover = typeof(options.showOnHover) === 'undefined' ? true : options.showOnHover;
    this.topOffset = typeof(options.topOffset) === 'undefined' ? 0 : options.topOffset;
...
Tooltip.prototype.draw = function() {
    ...
    div.style.left = (ne.x - (this.div_.offsetWidth / 2)) + 'px';
    div.style.top = (ne.y - this.topOffset) + 'px';
